                ...
                <div id="main">
                    ...
                    <div id="hero-image-wrapper">
                    	<div id="hero-background-layer" class="parallax-scroll-image">
                            <div id="hero-bg-image" style="background-image:url(<?=site_url("assets/images/01hero.jpg")?>)"></div>
                        </div>
                    </div>                        
                    <!--/Hero Section -->   
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                            ...
                            <div class="content-row light-section change-header-color" data-bgcolor="#fff">
                            	...
                            	<div class="one_half vertical-parallax" data-startparallax="0" data-endparallax="0.3">
                                    <figure>
                                        <a href="<?=site_url("assets/images/projects/liners01.jpg")?>" class="image-link"><img src="<?=site_url("assets/images/projects/liners01.jpg")?>" alt="Image Title"></a>               
                                ...
                                <div class="one_half last vertical-parallax" data-startparallax="0" data-endparallax="0.15">                                
                                    <figure>
                                        <a href="<?=site_url("assets/images/projects/liners02.jpg")?>" class="image-link"><img src="<?=site_url("assets/images/projects/liners02.jpg")?>" alt="Image Title"></a>               
                                        <figcaption>Image Caption Here</figcaption>
                                    </figure>                                    
                                </div>         
                            ...
                            <div class="content-row full dark-section" data-bgcolor="#171717">
                                ...
                                <figure class="has-parallax">
                                    <img src="<?=site_url("assets/images/projects/liners03.jpg")?>" alt="Image Title">
                                </figure>
                                ...
                                <div class="clapat-slider-wrapper content-slider has-animation autocenter dark-cursor">
        							<div class="clapat-slider">
                                        <div class="clapat-slider-viewport">
                                            <div class="clapat-slide"><div class="slide-img"><img src="<?=site_url("assets/images/projects/liners04.jpg")?>" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="<?=site_url("assets/images/projects/liners05.jpg")?>" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="<?=site_url("assets/images/projects/liners06.jpg")?>" alt="Image Title"></div></div>
                                        </div>
                                    </div>
                        ...
                        <div id="project-nav" class="">
                            <div class="next-project-wrap">
                                ...
                                <p class="all-works"><a class="link-text ajax-link" data-type="page-transition" href="index-showcase-grid.html"><span class="link" data-hover="View All Works">
                                    View All Works</span></a></p>
                                
                                <div class="next-project-caption text-align-center content-full-width height-title">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="<?=site_url("frontoffice/fonctionnalite/f2")?>" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
